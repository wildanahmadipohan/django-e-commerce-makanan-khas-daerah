 ...
 * Original file: /npm/bootstrap4-datetimepicker@5.2.3/src/js/bootstrap-datetimepicker.js
 *
  ...
  var n = function (n, a) {
    var r,
      ...
      O = function () {
        var t = e('<thead>').append(
          ...
          n = e('<tbody>').append(
            e('<tr>').append(e('<td>').attr('colspan', a.calendarWeeks ? '8' : '7'))
          );
        return [
          e('<div>')
          ...
          e('<div>')
            ...
            .append(e('<table>').addClass('table-condensed').append(t.clone()).append(n.clone())),
          e('<div>')
      ...
      Y = function () {
        ...
        if (
          ('auto' === o &&
            (o =
              i.top + 1.5 * m.height() >= e(window).height() + e(window).scrollTop() &&
              m.height() + n.outerHeight() < i.top
                ? 'top'
                : 'bottom'),
          'auto' === s &&
            (s =
              t.width() < i.left + m.outerWidth() / 2 && i.left + m.outerWidth() > e(window).width()
                ? 'right'
                : 'left'),
          'top' === o
      ...
      A = function () {
        ...
        for (
          !0 === a.calendarWeeks && t.append(e('<th>').addClass('cw').text('#'));
      ...
      V = function () {
        for (var t = [], n = i.clone().startOf('y').startOf('d'); n.isSame(i, 'y'); )
          t.push(
            e('<span>').attr('data-action', 'selectMonth').addClass('month').text(n.format('MMM'))
          ),
            n.add(1, 'M');
      ...
      R = function () {
        ...
        for (
          t.eq(0).find('span').attr('title', a.tooltips.prevDecade),
            ...
            a.maxDate && a.maxDate.isBefore(o, 'y') && t.eq(2).addClass('disabled');
          !n.isAfter(o, 'y');
      ...
      Q = function () {
        ...
        for (
          o.eq(0).find('span').attr('title', a.tooltips.prevCentury),
            ...
            (s.isSame(t({ y: 1900 })) || (a.minDate && a.minDate.isAfter(s, 'y'))) &&
              o.eq(0).addClass('disabled'),
            o.eq(1).text(s.year() + '-' + d.year()),
            (s.isSame(t({ y: 2e3 })) || (a.maxDate && a.maxDate.isBefore(d, 'y'))) &&
      ...
      G = function () {
        ...
        for (
          ...
          n.isSame(i, 'd') && (s || (i.hour() < 12 && n.hour() < 12) || i.hour() > 11);
      ...
      _ = function (e) {
        ...
        if (((e = e.clone().locale(a.locale)), C() && e.tz(a.timeZone), 1 !== a.stepping))
          for (
            e.minutes(Math.round(e.minutes() / a.stepping) * a.stepping).seconds(0);
      ...
      ae = {
        ...
        selectYear: function (t) {
          ...
          i.year(n),
            p === h ? (_(r.clone().year(i.year())), a.inline || ee()) : (j(-1), U()),
            B('YYYY');
        },
      ...
      ie = function () {
        ...
        return o.prop('disabled') || (!a.ignoreReadonly && o.prop('readonly')) || m
          ? c
          : (void 0 !== o.val() && 0 !== o.val().trim().length
              ...
              : u &&
                ...
                ((t = x()), 'string' == typeof a.useCurrent && (t = n[a.useCurrent](t)), _(t)),
            (m = I()),
            A(),
            V(),
    ...
    if (
      ...
      (c.locale = function (e) {
        ...
        return (
          (a.locale = e), r.locale(a.locale), i.locale(a.locale), d && fe(), m && (ee(), ie()), c
        );
      }),
      (c.stepping = function (e) {
        return 0 === arguments.length
          ? a.stepping
          : ((e = parseInt(e, 10)), (isNaN(e) || e < 1) && (e = 1), (a.stepping = e), c);
      }),
      ...
      (c.toolbarPlacement = function (e) {
        ...
        if (-1 === v.indexOf(e))
          throw new TypeError(
            'toolbarPlacement() parameter must be one of (' + v.join(', ') + ') value'
          );
      ...
      (c.widgetPositioning = function (t) {
        ...
        if (t.horizontal) {
          ...
          if (((t.horizontal = t.horizontal.toLowerCase()), -1 === g.indexOf(t.horizontal)))
            throw new TypeError(
              'widgetPositioning() expects horizontal parameter to be one of (' + g.join(', ') + ')'
            );
        ...
        if (t.vertical) {
          ...
          if (((t.vertical = t.vertical.toLowerCase()), -1 === b.indexOf(t.vertical)))
            throw new TypeError(
              'widgetPositioning() expects vertical parameter to be one of (' + b.join(', ') + ')'
            );
      ...
      throw new Error(
        'CSS class "' + a.datepickerInput + '" cannot be applied to non input element'
      );
    if (
    ...
    return (
      ...
      e.extend(
        ...
        (function () {
          var t,
            r = {};
          return (
            (t = n.is('input') || a.inline ? n.data() : n.find('input').data()).dateOptions &&
      ...
      n.is('input') ? o.on({ focus: ie }) : f && (f.on('click', oe), f.on('mousedown', !1)),
...
//# sourceMappingURL=/sm/7061170fcac1d68b912118c5cc436341950e87d3760116a2013235898f9abcfd.map
